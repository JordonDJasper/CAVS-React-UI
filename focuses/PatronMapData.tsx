...
export default function PatronFocusMapData() {
  ...
  useEffect(() => {
    ...
    ros.on('connection', () => {
      console.log('✅ Connected to ROSBridge (Patron Focus 2 - Map Data)');
    ...
    <div style={styles.container}>
      <div style={styles.mainContent}>
        ...
        <div style={styles.leftPanel}>
          ...
          {/* Patron: Camera mini-view replaces System Detail */}
      ...
      <div style={styles.bottomRectangles}>
        ...
        <Link to="/patron-focus-camera" style={{ textDecoration: 'none', width: '26.25%' }}>
          <div
            style={{
              ...styles.bottomRectangle,
        ...
        <Link to="/patron-focus-mapdata" style={{ textDecoration: 'none', width: '26.25%' }}>
          <div
            style={{
              ...styles.bottomRectangle,
